  ...
  return (
    <section id='contact' className='flex flex-col  bg-primary px-5 py-32 text-white'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='pb-5'>Looking for a professional web developer to build your next website? Let's talk and contact me today! <a className='bg-secondary px-5 py-2  font-bold hover:border-2 border-white rounded ' href='#'>Download</a></p>
